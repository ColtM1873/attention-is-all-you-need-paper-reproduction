...
## Reference
In code directory,  
almost all codes in to_make_a_model.py and to_make_a_train.py ,  
and part of codes in to_make_a_batch.py and main.py  
are from *The Annotated Transformer*, wroten by Vaswani et al. in 2022, presented by Harvard NLP.  
Though codes remain the same, they are extensively annotated by me, in my code files.  
## Structure
